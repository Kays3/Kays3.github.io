...
<div class="project-grid">
  ...
  <article class="project-card project-card--with-media">
    <figure class="project-card__media"><img src="/images/clinical/almaty-oita-yamaoka-visit-2024.jpg" alt="Kazakhstan and Japan infectious-disease research collaborators in 2024" loading="lazy" decoding="async"><figcaption>Patient to pathogen</figcaption></figure>
  ...
  <article class="project-card project-card--quiet project-card--with-media project-card--graduation">
    <figure class="project-card__media"><img src="/images/clinical/nazarbayev-md-graduates-2019.jpg" alt="Nazarbayev University School of Medicine's first MD graduating class in 2019" loading="lazy" decoding="async"><figcaption>MD 2019 · Photo: <a href="https://www.instagram.com/androbaza/">@androbaza</a></figcaption></figure>
